...
CREATE SCHEMA IF NOT EXISTS `CouchInn` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `CouchInn` ;

-- -----------------------------------------------------
-- Table `CouchInn`.`TipoDeUsuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`TipoDeUsuario` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`TipoDeUsuario` (
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Usuario` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Usuario` (
  `Id_Usuario` INT NOT NULL AUTO_INCREMENT,
  `Id_TipoDeUsuario` INT NOT NULL DEFAULT 1,
  ...
  `Id_CostoPremium` INT NOT NULL DEFAULT 1,
  `Cant_Calif` INT(11) NOT NULL DEFAULT 0,
  `Total_Calif` INT(11) NOT NULL DEFAULT 0,
  `Visible` TINYINT(1) NOT NULL  DEFAULT 1,
  `FechaAltaPremium` TIMESTAMP NULL,
  `FechaAlta` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, 
  PRIMARY KEY (`Id_Usuario`),
  INDEX (`Id_TipoDeUsuario`),
  FOREIGN KEY (`Id_TipoDeUsuario`) REFERENCES `TipoDeUsuario`(`Id_Tipo`),
  INDEX (`Id_CostoPremium`),
  FOREIGN KEY (`Id_CostoPremium`) REFERENCES `CostosPremium`(`Id_Costo`)
  ) 
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `CouchInn`.`CostosPremium`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`CostosPremium` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`CostosPremium` (
...
-- -----------------------------------------------------
-- Table `CouchInn`.`TipoDeCouch`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`TipoDeCouch` ;
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Couch`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Couch` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Couch` (
  `Id_Couch` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX (`Id_TipoDeCouch`),
  FOREIGN KEY (`Id_TipoDeCouch`) REFERENCES `TipoDeCouch`(`Id_Tipo`),
  INDEX (`Id_Provincia`),
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Comentario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Comentario` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Comentario` (
  ...
  FOREIGN KEY (`Id_Usuario`) REFERENCES `Usuario`(`Id_Usuario`),
  INDEX (`Id_Couch`),
  FOREIGN KEY (`Id_Couch`) REFERENCES `Couch`(`Id_Couch`)
  ) 
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `CouchInn`.`Punt_Couch`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Punt_Couch` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Punt_Couch` (
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Reserva`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Reserva` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Reserva` (
  `Id_Reserva` INT NOT NULL AUTO_INCREMENT,
  `Id_Usuario` INT NOT NULL,
  `Id_Couch` INT NOT NULL,
  `FechaInicio` DATE NOT NULL,
  `FechaFin` DATE NOT NULL,
  `Estado` ENUM('espera','confirmada','rechazada','vencida','cancelada','finalizada') NOT NULL DEFAULT 'espera',
  `Visible` TINYINT(1) NOT NULL  DEFAULT 1,
  `Calif_Huesped` TINYINT(1) NOT NULL  DEFAULT 0,
  `Calif_Couch` TINYINT(1) NOT NULL  DEFAULT 0,
  `Canc_Huesped` TINYINT(1) NOT NULL  DEFAULT 0,
  `Canc_Couch` TINYINT(1) NOT NULL  DEFAULT 0,
  `FechaAlta` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, 
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Punt_Usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CouchInn`.`Punt_Usuario` ;

CREATE TABLE IF NOT EXISTS `CouchInn`.`Punt_Usuario` (
  `Id_Puntaje` INT NOT NULL AUTO_INCREMENT,
  `Id_Usuario` INT NOT NULL,
  ...
  INDEX (`Id_Usuario`),
  FOREIGN KEY (`Id_Usuario`) REFERENCES `Usuario`(`Id_Usuario`),
  INDEX (`Id_Usuario_Punt`),
  FOREIGN KEY (`Id_Usuario_Punt`) REFERENCES `Usuario`(`Id_Usuario`)
  ) 
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `CouchInn`.`Provincias`
-- -----------------------------------------------------

DROP TABLE IF EXISTS `CouchInn`.`Provincias`;
CREATE TABLE IF NOT EXISTS `CouchInn`.`Provincias` (
...
INSERT INTO `CouchInn`.`Provincias` (`Id`, `Provincia`) VALUES
(1, 'Buenos Aires'),
(2, 'Buenos Aires-GBA'),
(3, 'Capital Federal'),
(4, 'Catamarca'),
...
-- -----------------------------------------------------
-- Table `CouchInn`.`Localidades`
-- -----------------------------------------------------

DROP TABLE IF EXISTS `CouchInn`.`Localidades`;
CREATE TABLE IF NOT EXISTS `CouchInn`.`Localidades` (
...
INSERT INTO `CouchInn`.`Localidades` (`Id`, `Id_Provincia`, `Localidad`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
-- -----------------------------------------------------
-- Data for table `CouchInn`.`CostosPremium`
-- -----------------------------------------------------
START TRANSACTION;
USE `CouchInn`;
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`) VALUES (NULL);
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (50, '2016-01-01');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (85, '2016-02-26');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (100, '2016-03-10');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (150, '2016-04-20');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (200, '2016-05-11');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (270, '2016-06-28');
INSERT INTO `CouchInn`.`CostosPremium` (`Costo`, `Fecha`) VALUES (300, '2016-07-05');
...
START TRANSACTION;
USE `CouchInn`;
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (1, 'Sandra', 'Lopez', 'sandra@gmail.com', '123456789', '1973-09-25', '45682231', '2016-05-01');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (2, 'Carlos', 'Rodriguez', 'carlos@gmail.com', '123456789', '1993-01-20', '4451856', '2016-01-04');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (1, 'Clara', 'Gonzalez', 'clara@gmail.com', '123456789', '1994-03-18', '45895982', '2016-07-10');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (2, 'Pedro', 'Romeo', 'pedro@gmail.com', '123456789', '1980-05-1', '45847214', '2016-03-11');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (1, 'Alfonso', 'Riquelme', 'alfonso@gmail.com', '123456789', '1980-05-1', '01145847214', '2016-05-14');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`, `Premium`, `Id_CostoPremium`, `FechaAltaPremium`) VALUES (1,'Roberto', 'Jimenez', 'roberto@gmail.com', '123456789', '1987-06-08', '4248388','2016-04-11' ,1,6, '2016-05-25');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`, `Premium`, `Id_CostoPremium`, `FechaAltaPremium`) VALUES (1,'Claudia', 'Perez', 'claudia@gmail.com', '123456789', '1992-02-17', '4186938', '2016-03-09',1,7, '2016-07-01');
INSERT INTO `CouchInn`.`Usuario` (`Id_TipoDeUsuario`, `Nombre`, `Apellido`, `Email`, `Password`, `FechaNac`, `Telefono`, `FechaAlta`) VALUES (2, 'Javier', 'Quintana', 'javier@gmail.com', '123456789', '1979-12-21', '4846234', '2016-05-20');
...
START TRANSACTION;
USE `CouchInn`;
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (1, 1, 1, 'Espectacular lugar en La Plata', 1, 73, 'Hermosa casa, ideal para tener un momento de relax y tranquilidad. Tengo una habitación extra para alojar visitantes.', 6, 'imagenes/couchs/1/1.jpg', 'imagenes/couchs/1/2.jpg', 'imagenes/couchs/1/3.jpg');
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (2, 5, 2, 'Gran Bungalow del Sur', 17, 1601, 'Hermosa casa, ideal para tener un momento de relax y tranquilidad viendo las majestuosas montañas de la patagonia. Tengo una habitación extra para alojar visitantes.', 7, 'imagenes/couchs/2/1.jpg', 'imagenes/couchs/2/2.jpg', '');
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (3, 3, 3, 'Muy buen departamento', 3, 313, 'Amplio departamento para vivir como nunca una experiencia porteña, a cuadras del obelisco y la peatonal florida.', 2, 'imagenes/couchs/3/1.jpg', 'imagenes/couchs/3/2.jpg', 'imagenes/couchs/3/3.jpg');
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (4, 7, 4, 'Impecable sotano amoblado', 1, 90, 'Situada en camet norte ofrece una bajada a la playa exclusiva.', 1, 'imagenes/couchs/4/1.jpg', '', '');
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (5, 2, 5, 'Dormis a la orilla del rio', 7, 790, 'Pequeños pero muy pintorescos ofrecen una flexibilidad sin igual para recorrer cuando quieras la zona.', 2, 'imagenes/couchs/5/1.jpg', 'imagenes/couchs/5/2.jpg', '');
INSERT INTO `CouchInn`.`Couch` (`Id_Couch`, `Id_TipoDeCouch`, `Id_Usuario`, `Titulo`, `Id_Provincia`, `Id_Localidad`, `Descripcion`, `Capacidad`, `Foto1`, `Foto2`, `Foto3`) VALUES (6, 6, 1, 'Amplio Garage', 17, 1665, 'Amoblado y reacondicionado para que tu estadia sea inolvidable, este garage es mucho mas de lo que parece.', 3, 'imagenes/couchs/6/1.jpg', '', '');

COMMIT;

-- -----------------------------------------------------
-- Data for table `CouchInn`.`Reserva`
-- -----------------------------------------------------
START TRANSACTION;
USE `CouchInn`;
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '1', '2', '2016-10-08', '2016-10-13', 'confirmada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '1', '3', '2016-08-04', '2016-08-11', 'espera', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '1', '4', '2016-06-02', '2016-06-09', 'confirmada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '1', '5', '2016-09-20', '2016-09-27', 'confirmada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '1', '3', '2016-07-21', '2016-07-24', 'rechazada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '2', '1', '2016-12-08', '2016-12-13', 'espera', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '2', '6', '2017-01-20', '2017-01-30', 'confirmada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
INSERT INTO `reserva` (`Id_Reserva`, `Id_Usuario`, `Id_Couch`, `FechaInicio`, `FechaFin`, `Estado`, `Visible`, `Calif_Huesped`, `Calif_Couch`, `Canc_Huesped`, `Canc_Couch`, `FechaAlta`) VALUES (NULL, '2', '5', '2016-07-10', '2016-07-20', 'confirmada', '1', '0', '0', '0', '0', CURRENT_TIMESTAMP);
