			...
			<nav>
				<div class="nav-wrapper white z-depth-3">
					...
					<ul class="right hide-on-med-and-down">
						...
						<li><a href="ayuda.php#comentarioscouch" class="light-green"><i class="large material-icons">help_outline</i></a></li>
					</ul>
				...
				<?php if($consulta_execute->num_rows) { ?>
					...
					<?php
						if ($pagina==1){
							...
							$paginaant=$pagina-1;
							echo '<li class="waves-effect"><a href="comentarioscouch.php?idcouch='.$idcouch.'&pagina='.$paginaant.'"><i class="material-icons">chevron_left</i></a></li>';
						}
						if ($total_paginas > 1){
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i){
									...
									echo '<li class="waves-effect"><a href="comentarioscouch.php?idcouch='.$idcouch.'&pagina='.$i.'">'.$i.'</a></li>';
								}
							}
							if ($pagina==$total_paginas){
								...
								$paginapos=$pagina+1;
								echo '<li class="waves-effect"><a href="comentarioscouch.php?idcouch='.$idcouch.'&pagina='.$paginapos.'"><i class="material-icons">chevron_right</i></a></li>';
							}
						}
					?>
					</ul>
